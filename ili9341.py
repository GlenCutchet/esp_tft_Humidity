...
'''Rev Dec1 adds a routine to draw arcs
   To make thing easier arcs are drawn in four clasic catesion quadrants
                            |
             ...
             ------------------------------------               
               ...
               Quadrant 3   |   Quadrant 4
                            |
                            |
               Zero degrees is the bootom of quadrant 1
               increasing counter clockwise
     Only 90 degree arcs are supported for now as this routine
     is for roundung the corners of a square box  to make a gui button
                            '''
...
class Display(object):
    ...
    def draw_button(self, x_start, y_start, width_x, hieght_y, r,color):
        #color = color565(255, 0, 255)
        h_line_start_x = x_start + r
        h_line_stop_x = x_start - r + width_x
        y_stop = y_start + hieght_y
        v_line_start_y = y_start + r
        v_line_stop_y = v_line_start_y + (hieght_y  - r - r)
        v_line_start_x = x_start
        v_line_stop_x = x_start + width_x
        #self.draw_hline( h_line_start_x, y_start, w, color):
        self. draw_line( h_line_start_x, y_start, h_line_stop_x, y_start, color)
        self. draw_line( h_line_start_x, y_stop, h_line_stop_x, y_stop, color)
        self. draw_line( x_start, v_line_start_y, x_start, v_line_stop_y, color)
        self. draw_line( v_line_stop_x, v_line_start_y, v_line_stop_x, v_line_stop_y, color)
        self.draw_arc_quadrant_1( x_start + width_x, y_start + r, r, color)
        self.draw_arc_quadrant_2( x_start +r+r , y_start + r , r, color)
        self.draw_arc_quadrant_3( x_start +r+r, v_line_stop_y, r, color)
        self.draw_arc_quadrant_4(x_start + width_x , v_line_stop_y , r, color)
    def draw_arc_quadrant_4(self, x_start, y_start, r, color):        
        """Draw a circle.

        Args:
            x_start (int): X coordinate start of arc.
            y_start (int): Y coordinate start of arc.
            x_end (int): X coordinate end of arc.
            y_end (int): Y coordinate end of arc.
        ...
        while x < y:
            ...
            #self.draw_pixel(x0 - x, y0 + y, color)  #end of quadrant 3
            #self.draw_pixel(x0 + x, y0 - y, color) #end of quadrant 1
            #self.draw_pixel(x0 - x, y0 - y, color) #start of quadrant 2
            self.draw_pixel(x0 + y, y0 + x, color) #end of quadrant 4
            #self.draw_pixel(x0 - y, y0 + x, color) #start of quadrant 3
            #self.draw_pixel(x0 + y, y0 - x, color)  #start of quadrant 1
            #self.draw_pixel(x0 - y, y0 - x, color) #end of quadrant 2
            '''           self.draw_pixel(x0 + x, y0 + y, color)
            self.draw_pixel(x0 - x, y0 + y, color)
            self.draw_pixel(x0 + x, y0 - y, color)
            self.draw_pixel(x0 - x, y0 - y, color)
            ...
            self.draw_pixel(x0 + y, y0 - x, color)
            self.draw_pixel(x0 - y, y0 - x, color)'''
    def draw_arc_quadrant_3(self, x_start, y_start, r, color):        
        """Draw a circle.
        ...
        while x < y:
            ...
            #self.draw_pixel(x0 + y, y0 - x, color)  #start of quadrant 1
            #self.draw_pixel(x0 - y, y0 - x, color) #end of quadrant 2
    #def draw_arc_quadrant_1(self, x_start, y_start,x_end,y_end, r, color):
    def draw_arc_quadrant_2(self, x_start, y_start, r, color):        
        """Draw a circle.
        ...
        while x < y:
            ...
            #self.draw_pixel(x0 + y, y0 - x, color)  #start of quadrant 1
            self.draw_pixel(x0 - y, y0 - x, color)    
    def draw_arc_quadrant_1(self, x_start, y_start, r, color):        
        """Draw a circle.
